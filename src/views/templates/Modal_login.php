<section id="modal_login">
    <div class="modal-card">
        <div class="modal-exit" onclick="toggleModalLogin()">
            <img src="./assets/img/icons/close.png" alt="Fechar tela de login">
        </div>
        <div class="logo">
            <img src="./assets/img/cordoba-logo.png" alt="Logo Cordoba">
        </div>
        <div class="modal-login-principal">
            <p>Use uma das opções</p>
            <div class="modal-social">
                <a href="#"><img src="./assets/img/icons/logo-facebook.png" alt="Login com o Facebook"></a>
                <a href="#"><img src="./assets/img/icons/logo-google.png" alt="Login com o Google"></a>
            </div>
